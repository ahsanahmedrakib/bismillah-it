...
export const cyberSecurityHeroData = {
...
export const cloudAndNetworkHeroData = {
...
export const zeroTrustHeroData = {
  title1: "Zero Trust",
  title2: "Framework",
  description1:
...
export const securityAwarenessHeroData = {
...
export const incidentResponseHeroData = {
  title1: "Cyber Security",
...
export const bitdefenderFeatures = [
